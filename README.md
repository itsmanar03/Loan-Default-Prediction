...
📊 Project Overview
The system analyzes applicant data (like credit score, income, and loan amount) to assess risk. To handle the data imbalance, SMOTE (Synthetic Minority Over-sampling Technique) was used during training to ensure the model can accurately identify potential defaulters.
...
High Performance: Achieved ~88% accuracy on test data.
...
Features Used: 16 different variables including Age, Income, Credit Score, and Loan Purpose.
